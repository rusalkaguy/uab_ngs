...
rsync -hmav "--include=**/" "--include=manifest.all.out" "--include=GS*-ASM.status.txt" "--include=*/*/*/ASM/*tsv*" "--include=*/*/*/ASM/*vcf*" "--include=*/*/*/ASM/REPORTS/*" "--exclude=*" . %TARGET% > rsync.log.txt
