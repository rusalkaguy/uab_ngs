...
# 
# qsub_usearch_merge_fastq.sh [-debug|-inline] 
#
########################################################################
# libraries to load
...
CMD_LINE_PARAM_LIST="PROJECT_DIR DATASET_NAME FWD_FASTQ REV_FASTQ OUT_FASTQ MINOVLEN TRUNCQAL"
# things we'll report on 
DERIVED_VAR_LIST="CMD_LINE HOSTNAME"
